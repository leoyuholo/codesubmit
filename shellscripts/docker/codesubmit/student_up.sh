...
default_argument="--livereload=35727 student"
...
docker run -i -p $mapped_host_port:8001 -p 35727:35727 -v $host_shared_dir:/host_shared --name $container_name ${USER}:$container_name $argument
